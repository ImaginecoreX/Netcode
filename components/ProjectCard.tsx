...
const ProjectCard = () => {
  return (
    <div className='w-full h-auto border-[1px] border-[#DDDDDD] rounded-[12px] box-border p-[24px] flex items-center gap-[74px]'>

        <div className='w-[400px] h-[400px] border-[1px] border-[#DDDDDD] relative rounded-[8px] flex-shrink-0'>
        ...
        <div>
          ...
          <div className='flex gap-[30px] items-center'>
            <div className='w-[88px] h-[88px] rounded-[4px] bg-black flex justify-center items-center'><div className='text-[48px] font-semibold text-white text-center'>W</div></div>
            <div>
