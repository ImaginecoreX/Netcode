...
return (
  <div className='w-full flex items-center sm:flex-col nsTsm:flex-col md:flex-col lg:flex-row xl:flex-row 2xl:flex-row'>
    {/* Column 1 */}
    <div className='w-[60%]  nsTsm:flex nsTsm:flex-col nsTsm:items-center sm:flex sm:flex-col sm:items-center md:items-center lg:items-start xl:items-start 2xl:items-start'>
      ...
      <div className='nsTsm:pb-[80px] md:pb-[80px] w-full'>
        ...
        <div className='nsTsm:w-full nsTsm:flex nsTsm:flex-col nsTsm:items-center mdup:flex-col mdup:flex mdup:items-center'><div className='text-[26px] font-normal leading-[38px] w-[80%] nsTsm:w-[80%] nsTsm:text-center mdup:w-[80%] mdup:text-center'>Drop your queries and we will get back
